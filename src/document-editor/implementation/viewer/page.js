...
var TableCellWidget = /** @class */ (function (_super) {
    ...
    TableCellWidget.prototype.getLeftBorderToRenderByHierarchy = function (leftBorder, rowBorders, tableBorders) {
        ...
        else if (!isNullOrUndefined(leftBorder) && (leftBorder.ownerBase instanceof WBorders) && (TableCellWidget.getCellOf(leftBorder.ownerBase).columnIndex === 0 || (TableCellWidget.getCellOf(leftBorder.ownerBase).cellIndex === 0 && TableCellWidget.getCellOf(leftBorder.ownerBase).ownerRow.rowFormat.gridBefore > 0))) {
            if (TableCellWidget.getCellOf(leftBorder.ownerBase).columnIndex !== 0 && TableCellWidget.getCellOf(leftBorder.ownerBase).ownerRow.rowFormat.gridBefore < 1
