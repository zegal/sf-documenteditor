...
import { beforeCommentActionEvent, trackChangeEvent } from '../../base/index';
/**
 * Editor module
 */
var Editor = /** @class */ (function () {
    ...
    Editor.prototype.insertCommentInternal = function (text) {
        ...
        var isAtSameParagraph = startPosition.isInSameParagraphIndex(endPosition);
    ...
    Editor.prototype.onApplyParagraphFormat = function (property, value, update, isSelectionChanged) {
        ...
        if (selection.isEmpty) {
            ...
            var footNoteWidgetsInfo = layout.getFootNodeWidgetsToShiftToPage(para);
            para = para.combineWidget(this.owner.viewer);
    ...
    Editor.prototype.deleteSelectedContent = function (paragraph, selection, start, end, editAction) {
        ...
        if (this.removeCommentCharacters.length > 0 && !this.isCmtDeleteStarted) {
            for (var k = 0; k < this.removeCommentCharacters.length; k++) {
                var currentBaseHistryInfo = this.editorHistory.currentBaseHistoryInfo;
                var commentStartChar = this.removeCommentCharacters[k];
                this.isCmtDeleteStarted = true;
    ...
    Editor.prototype.removeCommentsInline = function (inline) {
        if (inline instanceof CommentCharacterElementBox && inline.commentType === 1) {
            if (!inline.comment.isReply) {
                for (var i = 0; i < inline.comment.replyComments.length; i++) {
    ...
    Editor.prototype.removeContent = function (lineWidget, startOffset, endOffset, editAction) {
        ...
        var cmtStartToRemove = [];
        var removedCommentEnd = [];
     ...
     */
    Editor.prototype.skipCommentCharacter = function (inline) {
        var curentHistoryInfo = this.editorHistory.currentBaseHistoryInfo;
        ...
        if (this.editorHistory.currentHistoryInfo && this.editorHistory.currentHistoryInfo.action !== 'DeleteComment') {
            if (!(this.editorHistory.isUndoing || this.editorHistory.isRedoing)) {
                var offset = inline.line.getOffset(inline, 1);
                var startPosition = new TextPosition(this.owner);
                startPosition.setPositionParagraph(inline.line, offset);
                var startOff = this.selection.getHierarchicalIndexByPosition(startPosition);
                if (this.selection.isForward) {
                ...
                var baseHstry = this.editorHistory.currentBaseHistoryInfo;
    ...
    Editor.prototype.deleteCommentWidgetInline = function (inline) {
        ...
        if (this.editorHistory && this.editorHistory.currentHistoryInfo) {
            ...
            var lstActionHistoryInfo = this.editorHistory.currentHistoryInfo;
            var frstAction = lstActionHistoryInfo.modifiedActions[0];
    ...
    Editor.prototype.onEnter = function (isInsertPageBreak) {
        var selection = this.documentHelper.selection;
        var format = new SelectionCharacterFormat(this.selection);
